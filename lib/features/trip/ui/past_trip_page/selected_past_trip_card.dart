// Here we check if there is an image for the past trip and display it in a card widget. We use the placeholder image from the app assets if there is no image
